...
PROJECT_DESCRIPTION = "An Skybell HD Python library " "running on Python 3."
PROJECT_LONG_DESCRIPTION = (
    "skybellpy is an open-source "
...
USER_AGENT = "skybellpy/{}.{}.{}".format(MAJOR_VERSION, MINOR_VERSION, PATCH_VERSION)
...
SETTINGS_DO_NOT_RING = "do_not_ring"
...
ALL_SETTINGS = [
    ...
    SETTINGS_DO_NOT_RING,
    SETTINGS_OUTDOOR_CHIME,
    SETTINGS_MOTION_POLICY,
    SETTINGS_MOTION_THRESHOLD,
...
SETTINGS_MOTION_POLICY_VALUES = [SETTINGS_MOTION_POLICY_OFF, SETTINGS_MOTION_POLICY_ON]

SETTINGS_MOTION_THRESHOLD_LOW = 100
SETTINGS_MOTION_THRESHOLD_MEDIUM = 50
SETTINGS_MOTION_THRESHOLD_HIGH = 32
SETTINGS_MOTION_THRESHOLD_VALUES = [
    SETTINGS_MOTION_THRESHOLD_LOW,
...
SETTINGS_VIDEO_PROFILE_VALUES = [
    SETTINGS_VIDEO_PROFILE_1080P,
